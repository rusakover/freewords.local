...
var qw=parseInt(text.substr(0,4));

if (qw > 1900 && qw < 2100) {
var resultDate;
//if (teхt != '') { // если дата верная, то продолжение выполнения, иначе ничего не происходит
	var resultDate;
	...
	var year=new Array();
		...
		year[30]= '';year[31]= '';year[32]= '';year[33]= 'тридцать';year[34]= 'сорок';year[35]= 'пятьдесят';year[36]= 'шестьдесят';year[37]= 'семьдесят';year[38]= 'восемьдесят';year[39]= 'девяносто';
